...
{	
	...
	aim->add_sub_item(std::make_shared<D3DMenuBoolItem>(xorstr_("Enable"), s_aim, true));
	...
	misc->add_sub_item(std::make_shared<D3DMenuBoolItem>(xorstr_("Debug Info"), s_debuginfo, true));
